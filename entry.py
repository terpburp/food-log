...
font_style = ('Helvetica', 12) # font's family is Verdana, font's size is 12
...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='Welcome to your log! \n ...hopefully you have good news...', font=font_style, pady=10)
        label.grid(row=1, column=1) # center alignment
...
class AddPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Frame.__init__(self, parent)
        label = tk.Label(self, text='Log Page', font=font_style, pady=10)
...
class GoalPage(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        label = tk.Label(self, text='Nutritional Goals', font=font_style, pady=10)
...
class ViewPage(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        label = tk.Label(self, text='View Database Page', font=font_style, padx=10, pady=10)
...
class DataPage(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        label = tk.Label(self, text='Add to Database', font=font_style, padx=10, pady=10)
...
class SettingsPage(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        label = tk.Label(self, text='Settings', font=font_style, pady=10)
        label.pack(pady=10, padx=10)
